        ...
        <style>
            ...
            *, *::before, *::after {
            ...
            body:has(.fi-simple-page) {
                ...
                background-image:
                    radial-gradient(ellipse 80% 60% at 50% -10%, rgba(0,151,167,0.35) 0%, transparent 70%),
                    radial-gradient(ellipse 50% 40% at 100% 100%, rgba(66,183,196,0.15) 0%, transparent 60%) !important;
            ...
            .fi-simple-page {
                ...
                border: 1px solid rgba(0,151,167,0.25) !important;
            ...
            .fi-simple-page .fi-brand-logo { margin-bottom: 0.5rem !important; }

            .fi-simple-page .fi-brand-name,
            .fi-simple-page [class*="brand"] span {
                color: #ffffff !important;
                font-size: 1.5rem !important;
                font-weight: 800 !important;
                letter-spacing: -0.03em !important;
            ...
            /* Titre & sous-titre du form */
            .fi-simple-page h1,
            .fi-simple-page .fi-fo-component-ctn > h2 {
                color: #ffffff !important;
                font-weight: 700 !important;
                font-size: 1.15rem !important;
            }
            .fi-simple-page p,
            .fi-simple-page .fi-simple-page-description {
            ...
            .fi-simple-page input::placeholder { color: rgba(255,255,255,0.3) !important; }
            ...
            .fi-simple-page .fi-input-wrp svg { color: rgba(255,255,255,0.35) !important; }
            .fi-simple-page .fi-input-wrp:focus-within svg { color: var(--mc-secondary) !important; }

            /* Checkbox "Se souvenir de moi" */
            .fi-simple-page .fi-fo-field-wrp-label-after { color: rgba(255,255,255,0.65) !important; }
            ...
            .fi-simple-page button[type="submit"]:hover {
                box-shadow: 0 6px 28px rgba(0,151,167,0.55) !important;
                transform: translateY(-1px) !important;
            }

            /* Lien "Mot de passe oublié" */
            .fi-simple-page a:not(.fi-logo) {
                color: var(--mc-secondary) !important;
                font-size: 0.82rem !important;
            }
            .fi-simple-page a:not(.fi-logo):hover {
                color: #ffffff !important;
            }
